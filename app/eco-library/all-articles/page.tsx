...
export default function FloraFaunaPage() {
  return (
    <div className="bg-[#f8faf5] min-h-screen">
      {/* Hero Section */}
      <section className="relative h-80 bg-cover bg-center" style={{ backgroundImage: 'url(https://res.cloudinary.com/dc2mzcoqr/image/upload/v1750015029/intricate-line-art-earth-surrounded-diverse-flora-fauna-drawing-save-366564860_rinsr9.jpg)' }}>
        <div className="absolute inset-0 bg-black bg-opacity-50" />
        <div className="relative container mx-auto px-4 h-full flex items-center z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">All Articles</h1>
            <p className="text-xl text-white/90 mb-6">Discover all the Articles.</p>
