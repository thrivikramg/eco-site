...
export default function HomeSustainabilityHero() {
  return (
      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Home Sustainability Services</h1>
            <p className="text-lg md:text-xl text-gray-600 mb-8">
              Transform your home into an eco-friendly haven with sustainable solutions that reduce your environmental footprint and save on utility costs.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/services/home-sustainability/book">
                <Button size="lg" className="font-medium">
                  <Calendar className="mr-2 h-5 w-5" />
                  Book Now
                </Button>
              </Link>
              <Link href="#home-sustainability-services">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">Healthier Living</span>
              </div>
            </div>
          </div>
