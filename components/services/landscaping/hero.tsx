      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Sustainable Landscaping Services</h1>
            <p className="text-lg md:text-xl text-gray-600 mb-8">
              Transform your outdoor space with eco-friendly landscaping that enhances natural beauty while promoting environmental health.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/services/landscaping/book">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
              <div className="flex items-center">
                ...
                <span className="text-sm">Sustainable Design</span>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path
